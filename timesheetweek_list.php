...
print '\t\t});' . "\n";
print '\t}' . "\n";
print '\t// EN: Refresh the listing immediately when the limit changes just like diffusion_list.php.' . "\n";
print '\t// FR: Rafraîchit immédiatement la liste lorsque la limite change comme diffusion_list.php.' . "\n";
