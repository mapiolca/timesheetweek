...
print '\t\t// EN: Normalise the search terms to match the diffusion list matcher logic.' . "\n";
print '\t\t// FR: Normalise les termes de recherche pour reproduire la logique de correspondance de la liste diffusion.' . "\n";
...
print '\t\t});' . "\n";
print '\t}' . "\n";
print '\t// EN: Refresh the listing immediately when the limit changes, mirroring diffusion_list.php.' . "\n";
print '\t// FR: Rafraîchit immédiatement la liste lorsque la limite change, à l\'image de diffusion_list.php.' . "\n";
print '\t$(document).off("change.timesheetweekLimit", ".selectlimit").on("change.timesheetweekLimit", ".selectlimit", function () {' . "\n";
print '\t\tvar $current = $(this);' . "\n";
print '\t\tif ($limitHidden.length) {' . "\n";
print '\t\t\t$limitHidden.val($current.val());' . "\n";
print '\t\t}' . "\n";
print '\t\tvar $parentForm = $current.parents("form:first");' . "\n";
print '\t\tif ($parentForm.length) {' . "\n";
print '\t\t\t$parentForm.submit();' . "\n";
print '\t\t}' . "\n";
print '\t});' . "\n";
print '});' . "\n";
print '</script>';
