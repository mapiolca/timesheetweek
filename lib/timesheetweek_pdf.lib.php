 ...
 * @return float
 */
function tw_pdf_estimate_user_table_height($pdf, $langs, $userObject, array $columnWidths, array $columnLabels, array $recordRows, array $totalsRow, $lineHeight, $contentWidth, array $htmlFlags = array())
{
	...
	foreach ($recordRows as $rowValues) {
		$totalHeight += tw_pdf_estimate_row_height($pdf, $columnWidths, $rowValues, $lineHeight, $htmlFlags);
	}
