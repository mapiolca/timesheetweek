...
echo '.grille-saisie-temps .col-project-task { position: sticky; left: 0; background: #fff; z-index: 5; }';
echo '.grille-saisie-temps .col-summary-sticky { position: sticky; left: 0; background: #fff; z-index: 2; }';
echo '.grille-saisie-temps .liste_titre .col-project-task { z-index: 6; }';
