...
echo '.grille-saisie-temps .col-project-task { position: sticky; left: 0; background: #fff; z-index: 6; }';
echo '.grille-saisie-temps .col-summary-sticky { position: sticky; left: 0; background: #fff; z-index: 3; }';
echo '.grille-saisie-temps .liste_titre .col-project-task { z-index: 7; }';
echo '.grille-saisie-temps .liste_titre .col-summary-sticky { z-index: 5; }';
