...
class modTimesheetWeek extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		$workflowNotificationTemplates = class_exists('ActionsTimesheetweek') ? ActionsTimesheetweek::getNativeNotificationEmailTemplates() : array();
