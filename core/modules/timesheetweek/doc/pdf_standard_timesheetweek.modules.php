...
/**
 *  \file       core/modules/timesheetweek/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_timesheetweek
 */
class pdf_standard_timesheetweek extends ModelePDFTimesheetWeek
{
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if (getDolGlobalString('TIMESHEETWEEK_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			$this->watermark = getDolGlobalString('TIMESHEETWEEK_DRAFT_WATERMARK');
		}
		...
		/*
		if (getDolGlobalInt('MAIN_GENERATE_TIMESHEETWEEK_WITH_PICTURE'))) {
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	TimesheetWeek	$object     	Object to show
