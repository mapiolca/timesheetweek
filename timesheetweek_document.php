...
/**
 *  \file       timesheetweek_document.php
 *  \ingroup    timesheetweek
 *  \brief      Tab for documents linked to TimesheetWeek
 */
...
// Header
// ------
$title = $langs->trans("TimesheetWeek")." - ".$langs->trans("Files");
//$title = $object->ref." - ".$langs->trans("Files");
$help_url = '';
//Example $help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-timesheetweek page-card_document');

// Show tabs
$head = timesheetweekPrepareHead($object);

print dol_get_fiche_head($head, 'document', $langs->trans("TimesheetWeek"), -1, $object->picto);
