...
/**
 *  \file       timesheetweek_contact.php
 *  \ingroup    timesheetweek
 *  \brief      Tab for contacts linked to TimesheetWeek
 */
...
$langs->loadLangs(array("timesheetweek@timesheetweek", "companies", "other", "mails"));
...
$title = $langs->trans("TimesheetWeek")." - ".$langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-timesheetweek page-card_contact');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("TimesheetWeek"), -1, $object->picto);
