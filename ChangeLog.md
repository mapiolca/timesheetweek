...
- Fige le sélecteur des jours en haut de la vue mobile pendant le défilement, renforce le contraste du jour actif et rétablit le maintien du bouton Enregistrer en supprimant le formulaire mobile imbriqué. / Keeps the day selector fixed at the top of the mobile view while scrolling, strengthens the active-day contrast and restores the persistent Save button by removing the nested mobile form.
