...
## 1.8.4 (29/06/2026)
- Supprime la migration legacy des valeurs de modèles de courriel Notifications : à l'activation, une valeur existante ou absente est conservée sans création, copie ni remigration automatique. / Removes legacy migration of Notification email-template values: on activation, an existing or missing value is preserved without automatic creation, copy or remigration.
