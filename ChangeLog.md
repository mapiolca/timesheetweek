...
## 1.8.4 (29/06/2026)
- Ajoute l'affichage natif des dernières feuilles TimesheetWeek sur la fiche bancaire utilisateur via le hook natif `formObjectOptions`, avec droits lecture/propre/subordonnés/toutes et état dédié dans l'onglet Compatibilité. / Adds a native display of the latest TimesheetWeek rows on the user bank card through the native `formObjectOptions` hook, with own/subordinate/all read rights and a dedicated Compatibility tab status.
