...
- Filtre les feuilles, sélecteurs, actions AJAX et PDF selon l'accès du salarié à l'entité de la feuille. / Filters sheets, selectors, AJAX actions and PDFs according to the employee's access to the sheet entity.
