...
- Améliore la lisibilité des tâches sur mobile en masquant leur référence et en ajoutant un réglage par entité pour afficher les libellés sur une ligne, deux lignes ou sans limitation. / Improves mobile task readability by hiding task references and adding a per-entity setting for one-line, two-line or unrestricted labels.
- Aligne les saisies entre tous les projets, limite les libellés à 60 % de la ligne et réserve au moins 40 % aux champs horaires et aux sélecteurs forfait jour, y compris en mode quart de jour. / Aligns inputs across all projects, limits labels to 60% of the row and reserves at least 40% for hourly fields and daily-rate selectors, including quarter-day mode.
