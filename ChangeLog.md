...
## 1.8.4 (29/06/2026)
- Fige le sélecteur des jours en haut de la vue mobile pendant le défilement et renforce le contraste du jour actif indépendamment du focus de saisie. / Keeps the day selector fixed at the top of the mobile view while scrolling and strengthens the active-day contrast independently from input focus.
