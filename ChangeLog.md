...
- Ajoute les modèles de courriels natifs TimesheetWeek pour création, soumission, approbation, refus, retour en brouillon, scellement, descellement et suppression, expose les variables TimesheetWeek dans l'aide des modèles d'e-mails et conserve les choix administrateur lors des réactivations. / Adds native TimesheetWeek email templates for creation, submission, approval, refusal, revert to draft, sealing, unsealing and deletion, exposes TimesheetWeek variables in email-template help and preserves administrator choices across reactivations.
...
- Ajoute des notifications métier par étape avec modèles de courriel personnalisables de type `timesheetweek@timesheetweek`, sans migration des anciens modèles, pour soumission, approbation, refus, retour en brouillon, scellement et descellement. / Adds per-step business notifications with customizable `timesheetweek@timesheetweek` email templates, without legacy template migration, for submission, approval, refusal, revert to draft, seal and unseal.
