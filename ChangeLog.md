...
- Corrige la génération concurrente des références définitives, respecte l'entité propriétaire et le partage de numérotation, limite le JavaScript aux pages réellement concernées et ajoute la référence au titre de la fiche pour l'historique de navigation. / Fixes concurrent definitive-reference generation, respects the owner entity and numbering sharing, limits JavaScript to the pages that need it and adds the reference to the card title for navigation history.
