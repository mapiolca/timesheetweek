...
- Masque les références de tâche sur petits écrans, protège la largeur des saisies horaires et des sélecteurs forfait jour, y compris en mode quart de jour, et ajoute un réglage par entité pour afficher les libellés sur une ligne, deux lignes ou sans limitation. / Hides task references on small screens, protects hourly inputs and daily-rate selectors, including quarter-day mode, and adds a per-entity setting for one-line, two-line or unrestricted task labels.
