...
- Masque les références de tâche sur petits écrans, protège la largeur de la saisie horaire et ajoute un réglage par entité pour afficher les libellés sur une ligne, deux lignes ou sans limitation. / Hides task references on small screens, protects the time-entry width and adds a per-entity setting for one-line, two-line or unrestricted task labels.
