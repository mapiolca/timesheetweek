...
- Masque les références de tâche sur petits écrans, limite leur libellé à 60 % de la ligne, aligne et protège au moins 40 % de largeur pour les saisies horaires et les sélecteurs forfait jour entre tous les projets, y compris en mode quart de jour, et ajoute un réglage par entité pour afficher les libellés sur une ligne, deux lignes ou sans limitation. / Hides task references on small screens, limits their label to 60% of the row, aligns and protects at least 40% of the width for hourly inputs and daily-rate selectors across all projects, including quarter-day mode, and adds a per-entity setting for one-line, two-line or unrestricted task labels.
