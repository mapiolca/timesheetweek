...
SELECT 'TIMESHEETWEEK_CREATE', 'Création feuille de temps', 'Déclenché quand une feuille de temps est créée.', 'timesheetweek', 2098
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM llx_c_action_trigger WHERE code = 'TIMESHEETWEEK_CREATE');

INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
SELECT 'TIMESHEETWEEK_SAVE', 'Sauvegarde feuille de temps', 'Déclenché quand une feuille de temps est sauvegardée.', 'timesheetweek', 2099
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM llx_c_action_trigger WHERE code = 'TIMESHEETWEEK_SAVE');

INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
SELECT 'TIMESHEETWEEK_SUBMIT', 'Soumission feuille de temps', 'Déclenché quand une feuille de temps est soumise.', 'timesheetweek', 2100
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM llx_c_action_trigger WHERE code = 'TIMESHEETWEEK_SUBMIT');

INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
SELECT 'TIMESHEETWEEK_APPROVE', 'Approbation feuille de temps', 'Déclenché quand une feuille de temps est approuvée.', 'timesheetweek', 2101
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM llx_c_action_trigger WHERE code = 'TIMESHEETWEEK_APPROVE');

INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
SELECT 'TIMESHEETWEEK_REFUSE', 'Refus feuille de temps', 'Déclenché quand une feuille de temps est refusée.', 'timesheetweek', 2102
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM llx_c_action_trigger WHERE code = 'TIMESHEETWEEK_REFUSE');

INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
SELECT 'TIMESHEETWEEK_SENTBYMAIL', 'Envoi feuille de temps par email', 'Déclenché quand une feuille de temps est envoyée par email.', 'timesheetweek', 2106
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM llx_c_action_trigger WHERE code = 'TIMESHEETWEEK_SENTBYMAIL');

INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
SELECT 'TIMESHEETWEEK_DELETE', 'Suppression feuille de temps', 'Déclenché quand une feuille de temps est supprimée.', 'timesheetweek', 2103
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM llx_c_action_trigger WHERE code = 'TIMESHEETWEEK_DELETE');

INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
SELECT 'TIMESHEETWEEK_SEAL', 'Scellement feuille de temps', 'Déclenché quand une feuille de temps est scellée.', 'timesheetweek', 2104
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM llx_c_action_trigger WHERE code = 'TIMESHEETWEEK_SEAL');

INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
SELECT 'TIMESHEETWEEK_BACKTODRAFT', 'Réouverture feuille de temps', 'Déclenché quand une feuille de temps repasse en brouillon.', 'timesheetweek', 2105
FROM DUAL
