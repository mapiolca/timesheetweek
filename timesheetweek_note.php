...
/**
 *  \file       timesheetweek_note.php
 *  \ingroup    timesheetweek
 *  \brief      Tab for notes on TimesheetWeek
 */
...
$langs->loadLangs(array("timesheetweek@timesheetweek", "companies"));
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->timesheetweek->multidir_output[empty($object->entity) ? $conf->entity : $object->entity]."/".$object->id;
}
...
$title = $langs->trans('TimesheetWeek').' - '.$langs->trans("Notes");
//$title = $object->ref." - ".$langs->trans("Notes");
$help_url = '';
//$help_url='EN:Customers_Orders|FR:Commandes_Clients|ES:Pedidos de clientes';

llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-timesheetweek page-card_notes');
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("TimesheetWeek"), -1, $object->picto);
